...
class ContractAnalyzer:
    ...
    def __init__(self, model_name: str = "GermanT5/t5-efficient-gc4-all-german-small-el32"):
        """
        Initialize the ContractAnalyzer with GermanT5/t5-efficient-gc4-all-german-small-el32.
